...
<table>
  <tr>
    <td><img alt="image" src="inline-object:kix.dsgr4av9p377"/>
</td>
...
<br/>Uniform Inspection
  ...
  <tr>
    <td><strong>Group Demonstration
</strong><br/>
</td>
    <td>Introducing fire safety. Don&#39;t teach any specifics, just explain and talk about fire and listen to scouts opinions.
</td>
    <td>Teacher/SPL
</td>
    <td><strong>6:35 - 6:50
  ...
  <tr>
    <td><strong>Skills Instruction</strong><strong>
</strong><br/>Times here are fluid, but make sure to continue building <strong>
</strong></td>
    <td>E<strong>D</strong>GE
<br/>See lesson plan
<br/>
</td>
    <td>Teacher
  ...
  <tr>
    <td>on the edge method. Make sure that the scouts have fully learned the material by the <strong>
</strong></td>
    <td>ED<strong>G</strong>E
<br/>See lesson plan
<br/>
<br/>
</td>
  ...
  <tr>
    <td>end time. Alert SPL when complete.<strong>
</strong></td>
    <td>EDG<strong>E</strong>
<br/>See lesson plan
<br/>
<br/>
</td>
  ...
  <tr>
    <td><strong>Breakout Groups
</strong></td>
    <td>Patrol Meetings
<br/><strong>Patrol leaders should notify SPL when patrol business is complete if you want game time
</strong></td>
    <td>Patrol Leaders
</td>
    <td><strong>7:35 - 7:50
...
Bring tinder, kindling, and fuel. Not too much.
...
**The purpose of this lesson is not requirements, but to actually teach about fire safety**.



That means teachers, patrol leaders, don't just read off the book. Make logical questions about things that could really happen, so at a campout, we have no safety issues. Cover everything, not just what's in the book. That means putting out the fire, starting fires, the fire danger level, and the job of the fire guard at normal camps and at scout camp.
...
Start with the outdoor code. Have a volunteer list it off. Then ask a scout which they would say is the most important, and why. When one of them gets to be careful with fire, explain how dangerous fire can be. Don't just talk about how dangerous it is, ask a scout about the good things fire can do, and note that fire is a very useful resource. Ask scouts what they think are the most important fire safety rules. Guide them into the rules below
...
I will use the cold-out test to make sure the fire is cold out and will make sure the fire spot is cleaned before I leave it.



I follow the Outdoor Code, the Guide to Safe Scouting, and the principles of
...
Don't try to move wood in the pit with your hands. Instead, get a poker stick, and thoroughly waterlog it so it wont ketch. Do not leave the poker stick in the fire. Re-wet the stick as needed.



Make sure they remember this list as they continue earning their Firem?n Chit. It should serve as the foundation of their fire safety knowledge!
...
**Make sure that all gas connections are well-tightened \(but no need to over-tighten with tools\). - **Often, propane tasks are lefty-tighty, righty-loosen.



**Ensure all gas connections are fully secured and that there are no leaks- **You can do this by putting a bit of soapy water on the connections ? small bubbles will form over any leaks!
...
**Make sure that propane canisters are properly sealed and stored away **

**from open flames or excess heat. They could explode! - **In any situation, never ever place propane canisters near an open flame.



Now that they know the main fire safety rules for both campfires and propane, the rest of earning the Firem?n Chit should be easy. In the next few sections, they will be learning some of the ethics around fire, as well as more safety tips to avoid starting forest fires.
...
These rules are put in place to prevent campers from starting forest fires. Uncontrolled blazes can devastate natural resources and even kill innocent people. At times, a campfire may not be safe to light due to hazardous wind conditions.
...
As Scouts, we?re trained and prepared to stay warm and prepare food without a campfire. In fact, there are plenty of other ways to cook or stay warm without lighting fires \(such as hand warmers, electric heaters, stoves, propane, etc\)!



Also, even if in an area with fire restrictions, most of the time you have to purchase a permit from your county to legally light a campfire! Leaders should contact campsite authorities to ask whether a restriction is in place and if you can purchase a permit for the trip. \(for leaders\)
...
While all of these principles are extremely important, the thing they need to focus on today is Minimizing Campfire Impacts. The principle of minimizing campfire impacts focuses on reducing environmental damage and resource usage when building a fire.
...
Leaving a fire unattended can lead to some huge consequences. So, **whenever you build a fire, never leave it unattended!! **
...
-Water is great for dousing the burning fuel, which should put small wood fires out almost immediately. Water can also be used to make a poker stick, used by the fire guard to tend the fire.



You should also pour water over a fire you decide to smother. Putting dirt over burning logs will stop the flames, but the area will remain very hot for hours afterward. You should never leave the site of a fire while it?s still warm.
...
**7\) I will use the cold-out test to make sure the fire is cold out and will make sure the fire spot is cleaned before I leave it. **
...
Make sure to give your muddy campfire soup some time to cool off before performing the cold-out test to avoid burning yourself. Here?s the best and safest method I?ve found for performing the cold-out test.



1- Hold your hand about 6 inches over the entire area of the fire pit to see if it?s radiating heat.

2- Move your hand slowly around to see if there are any hot patches.

3- Then, stir the wet coals around one more time and feel over the area again.

4- If you notice any hot areas, stir them into the water.

5- If you don?t notice any warm areas, the area isn?t a fire hazard and should be safe to touch!
...
In my own experience, even when using water a fire can reignite. I have ?put out? multiple campfires that have reignited again before the pit had a chance to fully go cold. The cold-out test prevents that risk! -timmy
...
Now that we?re reaching the end of teaching for the** Scouts BSA Firem?n Chit \(or as most Scouts miscall it, the Fireman Chip\)**, it?s time to incorporate different Scouting outdoor principles into your fire building! We?ve already discussed Leave No Trace, so I?ll run through the other ones here.



Let?s start with the Outdoor Code: \(find a scout to say this from memory\)
...
This is just a great code to live by, whether you?re a Scout or not. The Outdoor Code reminds Scouts to be mindful while on outings and respect the natural wonders we enjoy as Scouts.



**The Guide to Safe Scouting **

The Guide to Safe Scouting is much longer than the Outdoor Code, but should still be read and followed at all times. It?s basically a tiny book that talks about the safety guidelines for almost every Scouting activity you can think of.
