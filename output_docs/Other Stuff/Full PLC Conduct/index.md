...
-PLC?s should be self sustaining

-Anyone can go to PLC
...
-The SPL has the power to cut off things that are not productive, and derail the meeting? This is different from normal RRO, because the chair normally is just there to run the meeting. Here, the SPL has more power to keep everything on track.
...
After being recognized by the SPL, any member can introduce a motion when no other motion is on the table.
...
The scribe needs to write down the motion, the second, and a brief summary of the motion, and the discussion that follows. The scribe should write down the outcome of the motion. This should be put in a google doc, and a short summary of the meeting should be made. This summary is called the meeting minutes, and it's what we will go over at the next meeting. A member can make a quick suggestion that something is explicitly stated in the notes, which needs to be seconded.
...
After recognition by the SPL, present your motion.
...
If a matter is considered relatively minor or opposition is not expected, a call for unanimous consent may be requested. If the request is made by others, the SPL will repeat the request and then pause for objections. If none are heard, the motion passes.
...
If you have a question about procedures -usage of procedures question

A question about anything else for the adults -Clarification from adults

**ADULTS ONLY - **If you hear something that is not factual -Fact check intervention

Say ?I would like to interject?

![image](inline-object:kix.3vg3bdytelzd)



In a normal RRoO meeting the Chair cannot vote. Therefore the SPL cannot vote unless to break a tie. The ASPLs are the Vice Chairs to the SPL.
...
Voting with a done by saying ?all in favor say I and raise hand? and then ?all not in favor say I and raise hand?
...
If a scout has a question about the procedures, ask an adult with the usage of procedures question \(Mr. Bennett is very knowledgeable about Roberts Rules, in most cases ask him\)

Scoutmaster, and assistant scoutmasters can make motions but cannot vote and cannot second.



Adults can interject if something is not factual!!
...
**Call to Order: **The chairperson or president officially begins the proceedings.

**Reading and Approval of Board Meeting Minutes: **The secretary presents the minutes from the last meeting for approval by the board. The members may amend errors in the minutes.

**Reports:** The board members view reports from executive committees, the auditor?s financial statements, investment advisor reports, and attorney reports.

**Old Business:** Members may take further action on agenda items that were tabled from the last meeting.

**New Business: **Members discuss and debate any new business before the board.

Adjournment: The board chair or other facilitator calls the official end to the meeting.



**Important stuff **

### Follow these 6 steps to file a motion:

Motion:  A member makes a motion to bring a particular business matter to the attention of the group. For example, a member of the board may call for a [vote of no-confidence](https://www.onboardmeetings.com/blog/vote-of-no-confidence/) if they believe a board member has made decisions that were harmful to the organization.

Second: Robert?s Rules only permit one topic for discussion at any time. To qualify for discussion, the primary motion must receive a second. A second indicates the willingness of at least one other person to raise the item for discussion. A second doesn?t mean the person is in favor of the motion. It just means the issue should receive debate.

Restate Motion: Once an item raised for discussion receives both a motion and a second, the chairperson restates the motion and places the item before the board for discussion and a vote.

Debate: The board debates the merits of the motion and listens to all perspectives in order to make an informed vote.

Vote: Under parliamentary rules, meeting decisions require a majority vote. A majority vote in the affirmative decides the issue before the board. Each member of the group agrees to be bound by the decision of the majority. Sometimes a group may require a two-thirds vote or a three-fourths vote on a particular issue.

Vote Announcement: Following a vote on an issue, the chairperson announces the results of the vote and the action taken. If supported by a majority vote, the motion is adopted.

Only one issue for debate at a time

Negative motions are not allowed

Only one person may speak at a time

All board members have equal rights

Each item presented for board action has a right to a full and fair debate

Everyone must be respectful

SPL has extra power to keep things running smoothly
